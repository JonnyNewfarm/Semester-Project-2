...
async function makeApiCall() {
    ...
    results.forEach(function (result) {
        ...
        <div class="card-body">
          ...
          <a href="details.html?id=${result.id}" class="btn btn-primary btn-lg">Add bid</a>
        </div>
      </div>
      </div>
         `;
...
const filterPosts = results.filter(function (result) {
    if(result.title.toLowerCase().startsWith(searchValue)) {
        return true;
    }
